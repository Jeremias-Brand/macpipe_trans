...
snakemake <- Snakemake(
    ...
    log = list(),
    resources = list(),
    config = list("adapters_fasta" = '/home/jeremias/soft/Trimmomatic-0.36/adapters/Truseq_barcodes.fa', "BUSCO" = '/home/jeremias/soft/busco/BUSCO.py', "homedir" = '/home/jeremias/dev/macpipe_trans/', "trim_trailing" = '30', "transrateDir" = '/home/jeremias/dev/macpipe_trans/transrate/', "BUSCO_p" = '/home/jeremias/soft/busco/BUSCO_plot.py', "fastqdir" = '/home/jeremias/dev/macpipe_trans/data/', "trim_leading" = '30', "transrate" = '/home/jeremias/soft/transrate-1.0.2-linux-x86_64/transrate', "trinity" = '/home/jeremias/soft/trinityrnaseq-2.2.0/Trinity', "BuscoLib" = '/home/jeremias/soft/busco/eukaryota_odb9', "py3" = '/home/jeremias/.linuxbrew/var/pyenv/versions/3.5.2/bin/python', "trim_minlength" = '25'),
    rule = 'plot_busco'
)
######## Original script #########
