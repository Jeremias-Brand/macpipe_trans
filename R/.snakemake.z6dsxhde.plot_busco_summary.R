...
snakemake <- Snakemake(
    input = list('busco/summary/short_summary_Macmini1_20170608.good.busco.txt', 'busco/summary/short_summary_Macmini2_20170608.good.busco.txt', 'busco/summary/', 'busco/summary/short_summary_Macmini1_20170608.busco.txt', 'busco/summary/short_summary_Macmini2_20170608.busco.txt', "good" = c('busco/summary/short_summary_Macmini1_20170608.good.busco.txt', 'busco/summary/short_summary_Macmini2_20170608.good.busco.txt'), "busco_folder" = 'busco/summary/', "normal" = c('busco/summary/short_summary_Macmini1_20170608.busco.txt', 'busco/summary/short_summary_Macmini2_20170608.busco.txt')),
    output = list('busco/summary/run_20170608_busco.pdf', "pdf" = 'busco/summary/run_20170608_busco.pdf'),
    params = list('20170608', "timestamp" = '20170608'),
    wildcards = list(),
    threads = 1,
    log = list(),
    resources = list(),
    config = list("trinity" = '/home/jeremias/soft/trinityrnaseq-2.2.0/Trinity', "fastqdir" = '/home/jeremias/dev/macpipe_trans/data/', "trim_leading" = '30', "trim_trailing" = '30', "BUSCO" = '/home/jeremias/soft/busco/BUSCO.py', "transrateDir" = '/home/jeremias/dev/macpipe_trans/transrate/', "BuscoLib" = '/home/jeremias/soft/busco/eukaryota_odb9', "py3" = '/home/jeremias/.linuxbrew/var/pyenv/versions/3.5.2/bin/python', "transrate" = '/home/jeremias/soft/transrate-1.0.2-linux-x86_64/transrate', "homedir" = '/home/jeremias/dev/macpipe_trans/', "BUSCO_p" = '/home/jeremias/soft/busco/BUSCO_plot.py', "trim_minlength" = '25', "adapters_fasta" = '/home/jeremias/soft/Trimmomatic-0.36/adapters/Truseq_barcodes.fa'),
    rule = 'plot_busco'
)
######## Original script #########
