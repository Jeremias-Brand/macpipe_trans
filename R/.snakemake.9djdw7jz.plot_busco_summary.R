...
snakemake <- Snakemake(
    input = list('busco/summary/short_summary_Macmini1_20170608.good.busco.txt', 'busco/summary/short_summary_Macmini2_20170608.good.busco.txt', 'busco/summary/short_summary_Macmini1_20170608.busco.txt', 'busco/summary/short_summary_Macmini2_20170608.busco.txt', 'busco/summary/', "good" = c('busco/summary/short_summary_Macmini1_20170608.good.busco.txt', 'busco/summary/short_summary_Macmini2_20170608.good.busco.txt'), "normal" = c('busco/summary/short_summary_Macmini1_20170608.busco.txt', 'busco/summary/short_summary_Macmini2_20170608.busco.txt'), "busco_folder" = 'busco/summary/'),
    ...
    log = list(),
    resources = list(),
    config = list("BUSCO_p" = '/home/jeremias/soft/busco/BUSCO_plot.py', "adapters_fasta" = '/home/jeremias/soft/Trimmomatic-0.36/adapters/Truseq_barcodes.fa', "trim_leading" = '30', "transrateDir" = '/home/jeremias/dev/macpipe_trans/transrate/', "transrate" = '/home/jeremias/soft/transrate-1.0.2-linux-x86_64/transrate', "BUSCO" = '/home/jeremias/soft/busco/BUSCO.py', "BuscoLib" = '/home/jeremias/soft/busco/eukaryota_odb9', "trim_trailing" = '30', "trim_minlength" = '25', "homedir" = '/home/jeremias/dev/macpipe_trans/', "py3" = '/home/jeremias/.linuxbrew/var/pyenv/versions/3.5.2/bin/python', "trinity" = '/home/jeremias/soft/trinityrnaseq-2.2.0/Trinity', "fastqdir" = '/home/jeremias/dev/macpipe_trans/data/'),
    rule = 'plot_busco'
)
######## Original script #########
