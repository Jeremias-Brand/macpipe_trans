...
snakemake <- Snakemake(
    input = list('transrate/summary/Macmini1.contigs.csv'),
    output = list('Macmini1.png'),
    params = list(),
    wildcards = list('Macmini1', "sample" = 'Macmini1'),
    threads = 1,
    log = list(),
    resources = list(),
    config = list("transrate" = '/home/jeremias/soft/transrate-1.0.2-linux-x86_64/transrate', "BUSCO" = '/home/jeremias/soft/busco/BUSCO.py', "py3" = '/home/jeremias/.linuxbrew/var/pyenv/versions/3.5.2/bin/python', "BUSCO_p" = '/home/jeremias/soft/busco/BUSCO_plot.py', "adapters_fasta" = '/home/jeremias/soft/Trimmomatic-0.36/adapters/Truseq_barcodes.fa', "fastqdir" = '/home/jeremias/dev/macpipe_trans/data/', "BuscoLib" = '/home/jeremias/soft/busco/eukaryota_odb9', "homedir" = '/home/jeremias/dev/macpipe_trans/', "trinity" = '/home/jeremias/soft/trinityrnaseq-2.2.0/Trinity', "transrateDir" = '/home/jeremias/dev/macpipe_trans/transrate/'),
