...
snakemake <- Snakemake(
    input = list('busco/summary/short_summary_Macmini1_20170608.busco.txt', 'busco/summary/short_summary_Macmini2_20170608.busco.txt', 'busco/summary/', 'busco/summary/short_summary_Macmini1_20170608.good.busco.txt', 'busco/summary/short_summary_Macmini2_20170608.good.busco.txt', "normal" = c('busco/summary/short_summary_Macmini1_20170608.busco.txt', 'busco/summary/short_summary_Macmini2_20170608.busco.txt'), "busco_folder" = 'busco/summary/', "good" = c('busco/summary/short_summary_Macmini1_20170608.good.busco.txt', 'busco/summary/short_summary_Macmini2_20170608.good.busco.txt')),
    ...
    log = list(),
    resources = list(),
    config = list("BUSCO_p" = '/home/jeremias/soft/busco/BUSCO_plot.py', "homedir" = '/home/jeremias/dev/macpipe_trans/', "trim_leading" = '30', "transrate" = '/home/jeremias/soft/transrate-1.0.2-linux-x86_64/transrate', "trinity" = '/home/jeremias/soft/trinityrnaseq-2.2.0/Trinity', "fastqdir" = '/home/jeremias/dev/macpipe_trans/data/', "trim_trailing" = '30', "py3" = '/home/jeremias/.linuxbrew/var/pyenv/versions/3.5.2/bin/python', "BuscoLib" = '/home/jeremias/soft/busco/eukaryota_odb9', "BUSCO" = '/home/jeremias/soft/busco/BUSCO.py', "adapters_fasta" = '/home/jeremias/soft/Trimmomatic-0.36/adapters/Truseq_barcodes.fa', "transrateDir" = '/home/jeremias/dev/macpipe_trans/transrate/', "trim_minlength" = '25'),
    rule = 'plot_busco'
)
######## Original script #########
