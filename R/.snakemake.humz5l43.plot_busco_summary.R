...
snakemake <- Snakemake(
    input = list('transrate/summary/Macmini1_20170608.contigs.csv', 'transrate/summary/Macmini2_20170608.contigs.csv', 'busco/summary/', 'transrate/summary/run_20170608_assemblies.csv', 'busco/summary/short_summary_Macmini1_20170608.busco.txt', 'busco/summary/short_summary_Macmini2_20170608.busco.txt', 'busco/summary/short_summary_Macmini1_20170608.good.busco.txt', 'busco/summary/short_summary_Macmini2_20170608.good.busco.txt', "busco_folder" = 'busco/summary/', "transrate_summary" = 'transrate/summary/run_20170608_assemblies.csv', "normal" = c('busco/summary/short_summary_Macmini1_20170608.busco.txt', 'busco/summary/short_summary_Macmini2_20170608.busco.txt'), "good" = c('busco/summary/short_summary_Macmini1_20170608.good.busco.txt', 'busco/summary/short_summary_Macmini2_20170608.good.busco.txt')),
    output = list('busco/summary/run_20170608_busco.pdf', 'busco/summary/run_20170608_busco_with_transrate.pdf', "busco_pdf" = 'busco/summary/run_20170608_busco.pdf', "busco_trans_pdf" = 'busco/summary/run_20170608_busco_with_transrate.pdf'),
    params = list('20170608', "timestamp" = '20170608'),
    wildcards = list(),
    threads = 1,
    log = list(),
    resources = list(),
    config = list("transrate" = '/home/jeremias/soft/transrate-1.0.2-linux-x86_64/transrate', "trinity" = '/home/jeremias/soft/trinityrnaseq-2.2.0/Trinity', "BuscoLib" = '/home/jeremias/soft/busco/eukaryota_odb9', "trim_trailing" = '30', "adapters_fasta" = '/home/jeremias/soft/Trimmomatic-0.36/adapters/Truseq_barcodes.fa', "transrateDir" = '/home/jeremias/dev/macpipe_trans/transrate/', "py3" = '/home/jeremias/.linuxbrew/var/pyenv/versions/3.5.2/bin/python', "homedir" = '/home/jeremias/dev/macpipe_trans/', "BUSCO" = '/home/jeremias/soft/busco/BUSCO.py', "trim_minlength" = '25', "fastqdir" = '/home/jeremias/dev/macpipe_trans/data/', "trim_leading" = '30', "BUSCO_p" = '/home/jeremias/soft/busco/BUSCO_plot.py'),
    rule = 'plot_busco'
)
######## Original script #########
