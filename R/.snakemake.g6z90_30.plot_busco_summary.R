...
snakemake <- Snakemake(
    ...
    log = list(),
    resources = list(),
    config = list("trinity" = '/home/jeremias/soft/trinityrnaseq-2.2.0/Trinity', "trim_minlength" = '25', "trim_leading" = '30', "transrateDir" = '/home/jeremias/dev/macpipe_trans/transrate/', "BUSCO" = '/home/jeremias/soft/busco/BUSCO.py', "homedir" = '/home/jeremias/dev/macpipe_trans/', "fastqdir" = '/home/jeremias/dev/macpipe_trans/data/', "BUSCO_p" = '/home/jeremias/soft/busco/BUSCO_plot.py', "adapters_fasta" = '/home/jeremias/soft/Trimmomatic-0.36/adapters/Truseq_barcodes.fa', "py3" = '/home/jeremias/.linuxbrew/var/pyenv/versions/3.5.2/bin/python', "transrate" = '/home/jeremias/soft/transrate-1.0.2-linux-x86_64/transrate', "trim_trailing" = '30', "BuscoLib" = '/home/jeremias/soft/busco/eukaryota_odb9'),
    rule = 'plot_busco'
)
######## Original script #########
