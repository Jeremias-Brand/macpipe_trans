...
my_species <- c('Mcla_subsample.good.busco', 'Mcla_subsample.good.busco', 'Mcla_subsample.good.busco', 'Mcla_subsample.good.busco', 'Mcla2_subsample.busco', 'Mcla2_subsample.busco', 'Mcla2_subsample.busco', 'Mcla2_subsample.busco', 'Mcla_subsample.busco', 'Mcla_subsample.busco', 'Mcla_subsample.busco', 'Mcla_subsample.busco', 'Mcla2_subsample.good.busco', 'Mcla2_subsample.good.busco', 'Mcla2_subsample.good.busco', 'Mcla2_subsample.good.busco')
...
my_percentage <- c(2.3, 1.7, 10.6, 85.4, 2.0, 2.3, 10.2, 85.5, 2.0, 2.3, 10.2, 85.5, 2.0, 2.0, 10.2, 85.8)
my_values <- c(7, 5, 32, 259, 6, 7, 31, 259, 6, 7, 31, 259, 6, 6, 31, 260)
