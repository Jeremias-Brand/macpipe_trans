...
my_species <- c('Mcla2_subsample.busco', 'Mcla2_subsample.busco', 'Mcla2_subsample.busco', 'Mcla2_subsample.busco')
...
my_percentage <- c(2.0, 2.3, 10.2, 85.5)
my_values <- c(6, 7, 31, 259)
